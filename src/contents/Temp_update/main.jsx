...
import { Temp_update } from './action';
...
class Main extends React.Component {
    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                dispatch(Temp_update({...values,id:this.props.Data.id}))
            }
        });
    }
    ...
    componentWillMount() {
        if (!Object.keys(this.props.Data).length) {
            this.props.history.push("/home/temp")
        }
    }
                ...
                <Form onSubmit={this.handleSubmit}>
                    ...
                    >
                        {getFieldDecorator('tempNumber', {
                            initialValue: this.props.Data.tempNumber,
                            rules: [{
                    ...
                    >
                        {getFieldDecorator('sign', {
                            initialValue: this.props.Data.sign,
                            rules: [{
...
function mapStateToProps(state) {
    return {
        Loading: state.Temp_update.btn_loading,
        Data: state.Temp_update.data,
    }
}
